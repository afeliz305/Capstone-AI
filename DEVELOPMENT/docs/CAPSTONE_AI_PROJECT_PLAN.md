...
The separate HelpDesk INC project demonstrates a useful ticket pattern, but Capstone - AI will not depend on that repository. This project will include its own minimal demo ticket queue instead of sending real professor emails.
...
- A floating **Capstone - AI** button and accessible chat panel.
